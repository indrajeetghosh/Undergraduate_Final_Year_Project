<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Menu.master" AutoEventWireup="true" CodeFile="Change_Password.aspx.cs" Inherits="Admin_Change_Password" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div align="center" style="margin-top:80px">
       ...
       <td colspan="2" align="right">
           <asp:Button ID="Button1" runat="server" Text="Change" BackColor="#000099" 
